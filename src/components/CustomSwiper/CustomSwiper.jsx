  ...
  <div className="inventory-wrapper h-full">
    <div id="" className="relative h-full">
      ...
      {showButton && type === "full" && (
        <>
          {" "}
          <button className="arrow-left absolute  top-[50%] translate-y-[-50%] left-[-55px] z-[999999999]">
            <Icon
          ...
          <button className="arrow-right absolute top-[50%] translate-y-[-50%] right-[-55px] z-[999999999]">
            <Icon
              className="w-[24px] h-[24px]  md:w-[48px] md:h-[48px]"
              icon="akar-icons:chevron-left"
              rotate={"180deg"}
